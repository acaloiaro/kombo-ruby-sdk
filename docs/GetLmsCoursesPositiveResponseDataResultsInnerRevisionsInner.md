# Kombo::GetLmsCoursesPositiveResponseDataResultsInnerRevisionsInner
...
| **course_id** | **String** | The Kombo ID of the course this revision belongs to. The ID can be used to retrieve the course from the &#x60;get courses&#x60; endpoint. |  |
| **title** | **String** | The title of the course revision. |  |
| **description** | **String** | A description of the course revision. |  |
| **status** | **String** | The status of this revision (ACTIVE or INACTIVE). |  |
...
| **skill_assignments** | [**Array&lt;GetLmsCoursesPositiveResponseDataResultsInnerRevisionsInnerSkillAssignmentsInner&gt;**](GetLmsCoursesPositiveResponseDataResultsInnerRevisionsInnerSkillAssignmentsInner.md) |  |  |
...
instance = Kombo::GetLmsCoursesPositiveResponseDataResultsInnerRevisionsInner.new(
  id: null,
  remote_id: null,
  course_id: null,
  title: null,
