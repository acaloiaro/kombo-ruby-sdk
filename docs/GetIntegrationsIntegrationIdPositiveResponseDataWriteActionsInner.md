# Kombo::GetIntegrationsIntegrationIdPositiveResponseDataWriteActionsInner

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **id** | **String** | ID of the action (e.g. ats_create_candidate). |  |
| **label** | **String** | Label of the action (e.g. Create candidate). |  |
...
| **fields** | [**Array&lt;GetIntegrationsIntegrationIdPositiveResponseDataWriteActionsInnerFieldsInner&gt;**](GetIntegrationsIntegrationIdPositiveResponseDataWriteActionsInnerFieldsInner.md) | Field support status for the action. Please note that action fields can&#39;t be configured in the scope config or opted out by your customer. |  |
...
instance = Kombo::GetIntegrationsIntegrationIdPositiveResponseDataWriteActionsInner.new(
  id: null,
  label: null,
  is_available: null,
