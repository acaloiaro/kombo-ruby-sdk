...
# Unit tests for Kombo::PatchHrisEmployeesEmployeeIdPositiveResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Kombo::PatchHrisEmployeesEmployeeIdPositiveResponseData do
  let(:instance) { Kombo::PatchHrisEmployeesEmployeeIdPositiveResponseData.new }

  describe 'test an instance of PatchHrisEmployeesEmployeeIdPositiveResponseData' do
    it 'should create an instance of PatchHrisEmployeesEmployeeIdPositiveResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Kombo::PatchHrisEmployeesEmployeeIdPositiveResponseData)
    end
  end
