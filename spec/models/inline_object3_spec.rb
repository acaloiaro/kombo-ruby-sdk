...
# Unit tests for Kombo::InlineObject3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Kombo::InlineObject3 do
  let(:instance) { Kombo::InlineObject3.new }

  describe 'test an instance of InlineObject3' do
    it 'should create an instance of InlineObject3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Kombo::InlineObject3)
    end
  end
