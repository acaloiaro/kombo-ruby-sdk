...
# Unit tests for Kombo::PostHrisEmployeesPositiveResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Kombo::PostHrisEmployeesPositiveResponseData do
  let(:instance) { Kombo::PostHrisEmployeesPositiveResponseData.new }

  describe 'test an instance of PostHrisEmployeesPositiveResponseData' do
    it 'should create an instance of PostHrisEmployeesPositiveResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Kombo::PostHrisEmployeesPositiveResponseData)
    end
  end
