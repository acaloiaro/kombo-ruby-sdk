...
module Kombo
  class GetHrisSkillsPositiveResponseDataResultsInner < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kombo::GetHrisSkillsPositiveResponseDataResultsInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kombo::GetHrisSkillsPositiveResponseDataResultsInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ordered_levels')
        if (value = attributes[:'ordered_levels']).is_a?(Array)
          self.ordered_levels = value
        end
      else
        self.ordered_levels = nil
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ordered_levels == o.ordered_levels &&
    ...
    def hash
      [id, remote_id, name, description, ordered_levels, changed_at, remote_deleted_at, remote_data].hash
    end
