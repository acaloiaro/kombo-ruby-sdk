...
module Kombo
  class GetHrisJobPositionsPositiveResponseDataResultsInner < ApiModelBase
    ...
    attr_accessor :parent_position_id
    ...
    def self.openapi_types
      {
        ...
        :'skills' => :'Array<GetHrisJobPositionsPositiveResponseDataResultsInnerSkillsInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kombo::GetHrisJobPositionsPositiveResponseDataResultsInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kombo::GetHrisJobPositionsPositiveResponseDataResultsInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'parent_position_id')
        self.parent_position_id = attributes[:'parent_position_id']
      else
        self.parent_position_id = nil
      end
    ...
    def hash
      [id, remote_id, name, description, legal_entity_id, location_id, department_id, group_ids, parent_position_id, skills, remote_data, changed_at, remote_deleted_at].hash
    end
