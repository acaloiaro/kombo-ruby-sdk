...
module Kombo
  class GetAtsApplicationsPositiveResponseDataResultsInner < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'candidate' => :'GetAtsApplicationsPositiveResponseDataResultsInnerCandidate',
        ...
        :'interviews' => :'Array<GetAtsApplicationsPositiveResponseDataResultsInnerInterviewsInner>',
        :'offers' => :'Array<GetAtsApplicationsPositiveResponseDataResultsInnerOffersInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kombo::GetAtsApplicationsPositiveResponseDataResultsInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kombo::GetAtsApplicationsPositiveResponseDataResultsInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'interviews')
        if (value = attributes[:'interviews']).is_a?(Array)
          self.interviews = value
        end
      else
        self.interviews = nil
      end
    ...
    def list_invalid_properties
      ...
      if @interviews.nil?
        invalid_properties.push('invalid value for "interviews", interviews cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @interviews.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] interviews Value to be assigned
    def interviews=(interviews)
      if interviews.nil?
        fail ArgumentError, 'interviews cannot be nil'
      end
    ...
    def hash
      [id, remote_id, outcome, rejection_reason_name, rejected_at, current_stage_id, job_id, candidate_id, screening_question_answers, custom_fields, integration_fields, remote_url, changed_at, remote_deleted_at, remote_created_at, remote_updated_at, remote_data, candidate, current_stage, job, interviews, offers].hash
    end
