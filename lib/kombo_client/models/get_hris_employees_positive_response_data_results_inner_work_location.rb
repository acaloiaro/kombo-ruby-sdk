...
module Kombo
  class GetHrisEmployeesPositiveResponseDataResultsInnerWorkLocation < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'remote_id' => :'String',
        :'name' => :'String',
        :'address' => :'GetHrisEmployeesPositiveResponseDataResultsInnerWorkLocationAddress',
        :'type' => :'String',
        :'changed_at' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kombo::GetHrisEmployeesPositiveResponseDataResultsInnerWorkLocation` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kombo::GetHrisEmployeesPositiveResponseDataResultsInnerWorkLocation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, remote_id, name, address, type, changed_at, remote_deleted_at, remote_data].hash
    end
