...
module Kombo
  class GetHrisPerformanceReviewsPositiveResponseDataResultsInnerReviewCycle < ApiModelBase
    ...
    attr_accessor :review_period_start_date
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kombo::GetHrisPerformanceReviewsPositiveResponseDataResultsInnerReviewCycle` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kombo::GetHrisPerformanceReviewsPositiveResponseDataResultsInnerReviewCycle`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'review_period_start_date')
        self.review_period_start_date = attributes[:'review_period_start_date']
      else
        self.review_period_start_date = nil
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          review_period_start_date == o.review_period_start_date &&
    ...
    def hash
      [id, remote_id, name, review_period_start_date, changed_at, remote_deleted_at, remote_data].hash
    end
