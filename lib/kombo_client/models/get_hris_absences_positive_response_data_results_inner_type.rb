...
module Kombo
  class GetHrisAbsencesPositiveResponseDataResultsInnerType < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Kombo::GetHrisAbsencesPositiveResponseDataResultsInnerType` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Kombo::GetHrisAbsencesPositiveResponseDataResultsInnerType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'half_days_supported')
        self.half_days_supported = attributes[:'half_days_supported']
      else
        self.half_days_supported = nil
      end

      if attributes.key?(:'exact_times_supported')
        self.exact_times_supported = attributes[:'exact_times_supported']
      else
        self.exact_times_supported = nil
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          unit == o.unit &&
          half_days_supported == o.half_days_supported &&
          exact_times_supported == o.exact_times_supported &&
    ...
    def hash
      [id, remote_id, name, unit, half_days_supported, exact_times_supported, remote_data, changed_at, remote_deleted_at].hash
    end
